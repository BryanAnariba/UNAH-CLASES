...
function enviarDatos(a,b){//FUNCION CON PARAMETROS
...
function mouseEnter(){//CAMBIA EL ESTILO AL ASOMAR EL MOUSE
...
function mouseLeave(){//RETORNA EL ESTILO ORIGINAL AL ASOMAR EL CLICK
